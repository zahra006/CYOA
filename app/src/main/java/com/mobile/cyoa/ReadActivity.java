...
//                        mContent.setId(content.getInt("id"));
//                        mContent.setId_content(content.getString("id_content"));
//                        mContent.setContent(content.getString("content"));
//                        mContent.setOption(content.getString("option"));
//                        list.add(mContent);
//                    }
//                }
//
